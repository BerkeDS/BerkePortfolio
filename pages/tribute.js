...
export default function Tribute(){
    ...
    — Mustafa Kemal
            ...
            <br/><br/>
            <h4>If you want more information about ATATÜRK, look here <a id="tribute-link" target="_blank" href="https://en.wikipedia.org/wiki/Mustafa_Kemal_Atat%C3%BCrk">Mustafa Kemal Atatürk</a></h4>
        </section>
    </main>
        </>
    );
